...
AnimationAddChained("BOMB_UP",noone,noone,anim_Spd,5,25,1,"IDLE");
AnimationAddChained("BOMB_LEFT",noone,noone,anim_Spd,26,46,1,"IDLE");
AnimationAddChained("BOMB_RIGHT",noone,noone,anim_Spd,47,66,1,"IDLE");
