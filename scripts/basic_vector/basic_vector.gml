...
function vector_zero() : vector(0,0) constructor 
{
    x = 0;
    y = 0;
}

function vector_random(_length = 1) : vector(0,0) constructor 
{
	var _dir = random(360);
...
function vector_lengthdir(_length, _dir) : vector(0,0) constructor 
{
    x = lengthdir_x(_length, _dir);
    y = lengthdir_y(_length, _dir);
}
